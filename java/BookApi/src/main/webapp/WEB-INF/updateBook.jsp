...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <body class="bg-slate-900 text-slate-100 font-sans min-h-screen flex flex-col justify-between">
        ...
        <main class="flex-grow max-w-2xl w-full mx-auto px-6">
            ...
            <form:form action="/updatingBook/${book.id}" method="POST" modelAttribute="book" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <form:input type="number" path="pages" value="${book.pages}"
                ...
                <div>
                    ...
                    <form:textarea path="description" rows="5" value="${book.description}"
                ...
                <div class="pt-2 flex items-center justify-end gap-3">
                    <a href="/book/${book.id}" class="text-xs text-slate-400 hover:text-slate-200 px-4 py-2 transition-colors">
                        Cancel
                    </a>
                    <button type="submit"
